...
describe('AppComponent', () => {
  ...
  it(`should have as title 'draftree'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app.title).toEqual('draftree');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span').textContent).toContain('draftree app is running!');
  });
});
